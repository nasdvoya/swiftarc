    ...
    <form on:submit={handleSubmit}>
        <div class="grid grid-cols-2 gap-8 text-left">
            ...
            <div>
                ...
                <Input name="email" label="Email" type="email" placeholder="johndoe@example.com" bind:value={formData.email} />
                ...
                <Input name="local_cobranca" label="Local de Cobrança" placeholder="Local de Cobrança" bind:value={formData.local_cobranca} />
            </div>
            ...
            <div>
                ...
                <Input name="tel_residencial" label="Tel. Residencial" placeholder="Telefone Residencial" bind:value={formData.tel_residencial} />
                <Input name="tel_trabalho" label="Tel. Trabalho" placeholder="Telefone Trabalho" bind:value={formData.tel_trabalho} />
                <Input name="telemovel" label="Telemóvel" placeholder="Telemóvel" bind:value={formData.telemovel} />
            </div>

            <!-- Observações (Textarea Spanning Two Columns) -->
            ...
            <!-- Buttons -->
            <button type="button" class="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg fixed rounded-full bottom-11 left-10 h-20 mb-14">
                Cancelar
            </button>
            <button type="submit"
